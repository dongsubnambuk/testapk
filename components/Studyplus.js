  ...
  return (
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <ScrollView style={styles.container}>
        ...
        <Text style={styles.mystudygroup_under}>성공의 지름길은 곧 마음가짐</Text>
        ...
        <View style={styles.mapPopup}>
          <MapView
            ...
            style={styles.map}
            initialRegion={{
              latitude: initialLocation ? initialLocation.latitude : 37.5665,
              longitude: initialLocation ? initialLocation.longitude : 126.9780,
